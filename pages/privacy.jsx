...
const sections = [
  {
    ...
    content: [
      ...
      "Payment Information: Payment details are processed securely by Stripe. We store only your Stripe customer ID and subscription status — never your card number.",
      "Calculation Data: If you save a calculation, we store the inputs and outputs you provide. You can delete saved calculations at any time from your dashboard.",
    ],
  },
  {
    ...
    content: [
      ...
      "To send transactional emails (e.g., sign-in links, subscription confirmations).",
  ...
  },
  {
    ...
    content: [
      ...
      "If you delete your account, all associated data (calculations, usage logs, sessions) will be permanently deleted within 30 days.",
    ],
  },
  {
    title: "5. Your Rights",
  ...
  },
  {
    ...
    content: [
      ...
      "We follow industry-standard security practices including secure headers, input validation, and regular dependency audits.",
    ],
  },
  {
...
export default function PrivacyPage() {
  return (
    <>
      <Head>
        <title>Privacy Policy - Voltiq</title>
        <meta
          name="description"
          content="Voltiq privacy policy — how we collect, use, and protect your data."
        />
      </Head>
