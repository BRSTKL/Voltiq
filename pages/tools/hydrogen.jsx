...
const toolMeta = getToolDefinition("hydrogen");
const toolName = toolMeta?.name || "Green Hydrogen Calculator";
const categoryLabel = toolMeta?.categoryLabel || "Hydrogen";
const toolDescription =
  toolMeta?.description ||
  "Levelized cost of hydrogen via electrolysis with CAPEX, OPEX, electricity cost and carbon intensity.";
const relatedTools = ["lcoe", "carbon", "scope2"];
