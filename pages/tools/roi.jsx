...
const toolMeta = getToolDefinition("roi");
const toolName = toolMeta?.name || "Solar ROI Calculator";
const categoryLabel = toolMeta?.categoryLabel || "Financial";
const toolDescription =
  toolMeta?.description ||
  "25-year cumulative return, payback period and electricity price escalation";
const relatedTools = ["solar", "lcoe", "battery"];
