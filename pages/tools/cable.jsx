...
const toolMeta = getToolDefinition("cable");
const toolName = toolMeta?.name || "Cable Sizing Calculator";
const categoryLabel = toolMeta?.categoryLabel || "Electrical";
const toolDescription =
  toolMeta?.description ||
  "DC/AC cable cross-section per IEC 60364 with voltage drop, ampacity derating and annual energy loss.";
const relatedTools = ["inverter-sizing", "solar", "pv-loss"];
