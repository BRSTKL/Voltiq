...
const toolMeta = getToolDefinition("carbon");
const toolName = toolMeta?.name || "Carbon Intensity Tracker";
const categoryLabel = toolMeta?.categoryLabel || "Sustainability";
const toolDescription =
  toolMeta?.description ||
  "Real-time grid carbon intensity by country with energy mix, CO2 footprint and country comparison.";
const relatedTools = ["scope2", "hydrogen", "lcoe"];
