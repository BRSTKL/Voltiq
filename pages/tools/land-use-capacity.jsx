...
const toolMeta = getToolDefinition("land-use-capacity");
const toolName = toolMeta?.name || "Land Use & Capacity Estimator";
const categoryLabel = toolMeta?.categoryLabel || "Solar";
const toolDescription =
  toolMeta?.description ||
  "Maximum installable capacity, panel count, and inverter pre-sizing from land area.";
const relatedTools = ["site-assessment", "solar", "wind"];
