...
import { Zap, BarChart3, Shield, Download } from "lucide-react";
...
const toolCategories = [
  {
    ...
    icon: Zap,
    tools: [
      { name: "Solar Yield Estimator", slug: "solar", description: "Estimate annual/monthly solar energy production based on system size, location, and panel specs." },
      { name: "PV Loss Breakdown", slug: "pv-loss", description: "Analyze losses from temperature, shading, soiling, wiring, and inverter inefficiency." },
      { name: "Shading Loss Analyzer", slug: "shading", description: "Calculate energy losses from horizon shading and nearby obstacles." },
      { name: "Inverter Sizing", slug: "inverter-sizing", description: "Determine optimal inverter capacity for your PV array with DC/AC ratio analysis." },
      { name: "Cable Sizing Calculator", slug: "cable", description: "Calculate minimum cable cross-section for voltage drop and current capacity." },
    ],
  },
  {
    ...
    icon: BarChart3,
    tools: [
      { name: "Solar ROI Calculator", slug: "roi", description: "Calculate return on investment, payback period, and NPV for solar projects." },
      { name: "Storage ROI Calculator", slug: "storage-roi", description: "Evaluate the financial viability of battery storage systems." },
      { name: "LCOE Comparator", slug: "lcoe", description: "Compare Levelized Cost of Energy across different generation technologies." },
    ],
  },
  {
    ...
    icon: Shield,
    tools: [
      { name: "Site Assessment", slug: "site-assessment", description: "Comprehensive site evaluation including solar resource, terrain, and grid proximity." },
      { name: "Wind Energy Estimator", slug: "wind", description: "Estimate wind energy production using Weibull distribution and turbine specs." },
      { name: "Land Use & Capacity Estimator", slug: "land-use-capacity", description: "Calculate land requirements and generation capacity for solar/wind farms." },
      { name: "Battery Storage Sizer", slug: "battery", description: "Size battery systems based on load profiles and backup requirements." },
    ],
  },
  {
    ...
    icon: Download,
    tools: [
      { name: "Carbon Intensity Tracker", slug: "carbon", description: "Track and compare carbon intensity across energy sources and regions." },
      { name: "Scope 2 Calculator", slug: "scope2", description: "Calculate Scope 2 greenhouse gas emissions from purchased electricity." },
      { name: "Green Hydrogen Calculator", slug: "hydrogen", description: "Estimate green hydrogen production costs and electrolyzer sizing." },
    ],
  },
];
...
export default function DocsPage() {
  return (
    <>
      <Head>
        <title>Documentation - Voltiq</title>
        <meta
          name="description"
          content="Voltiq documentation — learn how to use our renewable energy engineering tools."
        />
      </Head>
      <main className="mx-auto max-w-4xl px-4 py-12 sm:px-6 sm:py-16">
        ...
        <p className="mt-3 text-[var(--color-muted)] max-w-2xl">
          Everything you need to know to get started with Voltiq and make the
          most of our renewable energy calculation tools.
        </p>
        ...
        <section className="mt-14">
          ...
          <p className="mt-2 text-sm text-[var(--color-muted)]">
            Voltiq includes 15 engineering calculators organized into four
            categories.
          </p>
            ...
            {toolCategories.map((cat) => (
              <div key={cat.category}>
                <div className="flex items-center gap-2">
                  <cat.icon className="h-5 w-5 text-[var(--color-brand)]" />
